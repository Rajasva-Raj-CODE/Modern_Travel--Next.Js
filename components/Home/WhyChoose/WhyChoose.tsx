    ...
    return (
        <div className='pt-16 pb-24'>
            ...
            <div className='grid w-[80%] mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 items-center mt-20'>
                {/*Why Choose Card*/}
                <div data-aos="fade-up" data-aos-anchor-placements="top-center"  >
                ...
                <div data-aos="fade-up" data-aos-anchor-placements="top-center" data-aos-delay="150" >
                ...
                <div data-aos="fade-up" data-aos-anchor-placements="top-center" data-aos-delay="300">
